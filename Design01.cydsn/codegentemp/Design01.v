...
// IDAC_P4_v1_10(IDACRange=1, IDACValue=120, Polarity=1, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONFIG_TITLE=IDAC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC, CY_INSTANCE_SHORT_NAME=IDAC, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=IDAC, )
...
module top ;
	...
	wire [0:0] tmpINTERRUPT_0__Pin_In_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin_In
		 (.oe(tmpOE__Pin_In_net),
		  ...
		  .interrupt({tmpINTERRUPT_0__Pin_In_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	cy_psoc3_pins_v1_10
		#(.id("36a41e2e-33aa-4eed-99cb-3f1069cf41d8"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
